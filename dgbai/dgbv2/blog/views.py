...
tone_analyzer = ToneAnalyzerV3(
        username='f95915a6-9bf8-4887-b2e7-25ad090fa720',
        password='GxdsPfNzoexs',
        version='2017-09-26')
    #Language Translator Inputs
language_translator = LanguageTranslatorV3(
        version='2018-05-31',
        iam_apikey='5Cfmp2q373a498C0tncOFc-DMtbyCD2Ew2ZmCLea4yGv',
        url='https://gateway.watsonplatform.net/language-translator/api')

personality_insights = PersonalityInsights (
        version= '2018-10-12',
        username='b9706e8f-11ce-4899-9a7d-9890d0515571',
        password='dsbh2v0miUtq',)
